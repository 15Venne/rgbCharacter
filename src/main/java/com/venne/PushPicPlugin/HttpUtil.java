...
public class HttpUtil {
    ...
    public static String get(String requestUrl, String accessToken, String params)
            throws Exception {
        String contentType = "application/x-www-form-urlencoded";
        String encoding = "UTF-8";
        
        return HttpUtil.getGeneralUrl(requestUrl, contentType, params, encoding);
    }
    ...
    public static String sendGet(String url, String param) {
        ...
        try {
            ...
            for (String key : map.keySet()) {
                ...
                if(map.get(key).toString().contains("410 Gone")) {
                	return "410 Gone";
                }
            }
            // 定义 BufferedReader输入流来读取URL的响应
